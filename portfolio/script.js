...
$(function()
  ...
  function()
  {
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = _), exports._ = _) : n._ = _, _.VERSION =
      "1.6.0";
    ...
    }, _.throttle = function(n, t, e)
    {
      ...
      return function()
      {
        ...
        u || e.leading !== !1 || (u = l);
        var s = t - (l - u);
        return r = this, o = arguments, 0 >= s ? (clearTimeout(a), a = null, u = l, i = n.apply(r, o), r = o = null) : a || e.trailing === !1 || (a =
          setTimeout(c, s)), i
      }
  ...
  }.call(this), $(function()
  {
    function n(n)
    {
      window.ga && (con("Analytics event", n), ga("send", "event", n))
    }
    $(document).on("click", ".js-analytics-click", function(t)
    {
      if (window.ga)
      {
        ...
        n(
        {
          ...
          {
            t.isDefaultPrevented() && (location = o, con("Analytics hit callback"))
          }
        })
      }
  ...
  }), $(function()
  {
    ...
    if (n[0] && window.Photos)
    {
      ...
      con("# Fotorama events"), n.on(
        "fotorama:ready fotorama:show fotorama:showend fotorama:load fotorama:error fotorama:fullscreenenter fotorama:fullscreenexit ", function(n, t, e)
        {
          con("## " + n.type), e && e.src || con("active image: " + t.activeFrame.img), e && (e.time && con("transition duration: " +
            Math.round(e.time) + "ms"), e.src && con(("fotorama:load" === n.type ? "loaded" : "broken") + " image: " + e.src)), con("")
        }).fotorama(
      {
        data: m,
      ...
      t.on("resize", function()
      {
        ...
        var o = e * i,
          l = Math.round(g / a);
        e !== w && (con("Resize thumbs to " + o + "×" + e + "px"), con(""), $.extend(r,
        {
          thumbwidth: o,
          thumbheight: e
        }), j.css(
        {
          bottom: e + 2 * u
        }), w = e), l !== b && (con("Set min height to " + l + "px"), con(""), $.extend(r,
        {
          minheight: l
  ...
  }), $(function()
  {
    ...
    {
      con("document click"), ("click" === n.type || 27 === n.keyCode) && t()
    })
  }), $(function()
  {
  ...
  }), $(function()
  {
    function n(n)
    {
      location.replace(location.protocol + "//" + location.host + location.pathname.replace(/^\/?/, "/") + location.search + "#" + n), $('li[data-tag="' +
